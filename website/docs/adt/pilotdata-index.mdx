...
description: The Aria Pilot dataset is the first open dataset captured using Project Aria
...
<video width="950" controls>
  <source src={useBaseUrl('img/adt/location_all_activities.m4v')} type="video/mp4"/>
...
* [Activities](https://facebookresearch.github.io/Aria_data_tools/docs/pilotdata/everyday/activities) provides details of the scenarios recorded and where specific activities are in the recording sequence
* [Recording Scripts](https://facebookresearch.github.io/Aria_data_tools/docs/pilotdata/everyday/scripts) provides more details about each scenario
* [Everyday Activities Sensor Profile](https://facebookresearch.github.io/Aria_data_tools/docs/pilotdata/everyday/sensor-profiles) provides information about the sensor profile used to gather data
* [Everyday Activities File Structure](https://facebookresearch.github.io/Aria_data_tools/docs/pilotdata/everyday/everyday) provides information about how the data is structured and information about raw sensor data

In addition to the raw sensor data, we’ve provided derived meta-data for:

* High-frequency trajectory in 1KHz - [Location Output Data](https://facebookresearch.github.io/Aria_data_tools/docs/pilotdata/location-output)
* High-frequency time-synchronization between multiple users in the same activity - [Timestamps Mapping Data](https://facebookresearch.github.io/Aria_data_tools/docs/pilotdata/timestamps)
* Eye gaze reprojected into the RGB camera stream - [Eye Gaze Data](https://facebookresearch.github.io/Aria_data_tools/docs/pilotdata/reprojected-gaze)
* Time-aligned speech to text - [Speech2Text Output Data](https://facebookresearch.github.io/Aria_data_tools/docs/pilotdata/speech2text)

The data has been gathered across five indoor locations. Data for each location is [stored in their own folder](https://facebookresearch.github.io/Aria_data_tools/docs/pilotdata/everyday/everyday).
...
* [Desktop Activities Data Overview](https://facebookresearch.github.io/Aria_data_tools/docs/pilotdata/desk/desktop_overview) provides an overview of the dataset and the data structure.
* [Desktop Activities Capture Setup](https://facebookresearch.github.io/Aria_data_tools/docs/pilotdata/desk/desktop_setup) provides more information about the capture setup and sensor profile used.


<video width="950" controls>
  <source src={useBaseUrl('img/adt/desk_12-demo.m4v')} type="video/mp4"/>
  Your browser does not support the video tag.
</video>
...
* [Install Data Tools](https://facebookresearch.github.io/Aria_data_tools/docs/install)
* [Aria Data Tools Examples](https://facebookresearch.github.io/Aria_data_tools/docs/howto/examples)
* [Aria Data Tools Documentation](https://facebookresearch.github.io/Aria_data_tools/docs/overview)
* [Sensors and Measurements](https://facebookresearch.github.io/Aria_data_tools/docs/sensors-measurements)


You can also work with this data using standard VRS commands.

* [How Project Aria Uses VRS](https://facebookresearch.github.io/Aria_data_tools/docs/aria-vrs)
* [Getting to Know and Use VRS Data](https://facebookresearch.github.io/Aria_data_tools/docs/use-vrs)

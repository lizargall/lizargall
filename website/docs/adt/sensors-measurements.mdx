...
description: This page provides an overview of the sensors and measurements we use for Project Aria devices
---
...
* [Project Aria device sensors](#sensors)
* [Naming conventions for all the tools and IDs used for sensors](#naming)
* [Coordinate systems](#coordinate)
* [Time (inc time stamping and camera shutter types)](#time)
* [GPS](#gps)

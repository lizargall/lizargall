...
* [Academic Partners only] Join Project Aria Academic Partner Announcements, Feedback & Support
    ...
    * See [How to join the Academic Partner Workplace group](https://facebookresearch.github.io/projectaria_tools/docs/ARK/workplacegroup) for further instructions.
...
Go to the Recordings section in the Desktop app to download your data. See the [Desktop App page](https://facebookresearch.github.io/projectaria_tools/docs/ARK/desktop_companion_app) for further information.

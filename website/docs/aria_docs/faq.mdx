...
[Project Aria Tools](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/data_utilities) provides open source Python and C++ code and APIs for working with Aria data. Due to the multimodal nature of Project Aria data, the data is stored in [VRS files](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/aria_vrs/aria_vrs). Project Aria Tools provides API wrappers for using VRS tools, specifically tailored to working with Aria data. Using Project Aria Tools should make it easier to plug your data into other applications with more accessible formatting and labeling.

If there are VRS functions you wish Project Aria Tools had, please contact us using any of our [Support Channels](https://facebookresearch.github.io/projectaria_tools/docs/support).


#### APIs
* [DataProvider](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/core_code_snippets/data_provider)
    * Read Project Aria sequences and raw sensor data (VRS files)
* [Calibration](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/core_code_snippets/calibration)
    * Retrieve calibration data and interact with Aria camera models
* [MPS](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/core_code_snippets/mps)
    * Read Project Aria MPS (derived) data
* Images
    * [Python Visualization Guide](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/visualization/visualization_python)
    * [C++ Visualization Guide](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/visualization/visualization_cpp)
...
The [vrs_to_mp4](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/advanced_code_snippets/vrs_to_mp4) script exports a VRS file to MP4 and was created to help researchers send files for review more easily. Please note, MP4 files will not contain the full sensor suite.
...
* [Project Aria MPS Command Line Interface (MPS CLI)](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/request_mps/mps_cli) is a convenient way to request [Machine Perception Services (MPS)](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps). Through the MPS CLI you can request:
    * [SLAM](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/slam), [Eye Gaze](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/mps_eye_gaze) and [Hand Tracking](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/hand_tracking/) data.
    * [Multi-sequence SLAM data](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/slam/mps_multi_slam) - SLAM data generated using multiple VRS recordings in a shared coordinate frame.
...
* (Optional) ARCore Depth API ([https://developers.google.com/ar/devices](https://developers.google.com/ar/devices)) support needed for [eye-tracking calibration](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/eye_gaze_calibration)
* 64-bit is preferred, although 32-bit is supported

If you're using iOS:

* OS version must be iOS 14 or above
* (Optional) TrueDepth camera (iPhone X or later) needed for [eye-tracking calibration](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/eye_gaze_calibration)
...
Accessed via the PyPI installation of Project Aria Tools, the [Project Aria MPS Command Line Interface (MPS CLI)](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/request_mps/mps_cli) provides a streamlined way to request [Machine Perception Services (MPS)](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps):

* Request [SLAM](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/slam), [Eye Gaze](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/mps_eye_gaze) and [Hand Tracking](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/hand_tracking) data
* Request [Multi-Sequence SLAM data](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/slam/mps_multi_slam)
...
While Aria data can be downloaded using the Desktop app, it may be faster to [download the data using other means](ARK_quickstart.mdx#download-data).
...
* Linux, debian package for Ubuntu, 22.04 LTS version. The app was only tested for that specific version under Gnome 42.5 and X11 (X Server) as well as Wayland. Any other debian distribution (Ubuntu 22.04 fork such as Kubuntu, Mint etc.) or environment may or may not work.
    * V36 only, please use the [MPS CLI](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/request_mps/mps_cli) or [Aria Studio](https://facebookresearch.github.io/projectaria_tools/docs/ARK/aria_studio) to request Hand Tracking MPS
...
* [How Project Aria Uses VRS](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/aria_vrs)
* [Getting Started Guide](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/getting_started) (view sample data via Jupyter Notebook or Google Colab)
* [Download Project Aria Tools Codebase](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/installation/download_codebase)
...
We recommend using [Trajectory MPS outputs](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/slam/mps_trajectory) instead of raw IMU data wherever possible. Go to [MPS Code Snippets](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/core_code_snippets/mps) for how to load open loop or closed loop trajectory data.


### What calibration information is available?
#### General calibration concepts

* [2D Image Coordinate System Conventions](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/coordinate_convention/2d_image_coordinate_system_convention) (intrinsics)
* [3D Coordinate Frame Conventions](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/coordinate_convention/3d_coordinate_frame_convention) (extrinsics, non-visual sensor coordinate systems and CPF)
* [Calibration Code Snippets](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/core_code_snippets/calibration)
* [Tech Insights](https://facebookresearch.github.io/projectaria_tools/docs/tech_insights) - technical deeper dives on domain-specific topics, such as how we model sensors mathematically in calibration:
    * [Camera intrinsic models](https://facebookresearch.github.io/projectaria_tools/docs/tech_insights/camera_intrinsic_models)
    * [Sensor measurement model](https://facebookresearch.github.io/projectaria_tools/docs/tech_insights/sensor_measurement_model)
...
The calibration parameters contain [intrinsics](https://facebookresearch.github.io/projectaria_tools/docs/tech_insights/camera_intrinsic_models) and [extrinsics](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/coordinate_convention/3d_coordinate_frame_convention) parameters for each sensor as well as a time offsets that best temporally align their data.


#### In-Session Eye Gaze Calibration

This is not related to standard calibration. [In-Session Eye Gaze Calibration](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/eye_gaze_calibration) enables researchers to improve the eye gaze estimations in Eye Gaze MPS outputs, enabling researchers to more accurately determine where wearers are looking during the recordings.
...
Project Aria Tools provides VrsDataProvider which offers some, but not all, of the VRS API capabilities. Go to [How Project Aria Uses VRS](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/aria_vrs/aria_vrs) for more information.

We’ve tailored VrsDataProvider to meet the requirements of people using Aria data. If there are capabilities in the VRS API that you would like to access when using Project Aria Tools, please use one of our [Support channels](https://facebookresearch.github.io/projectaria_tools/docs/support) to let us know what you’re looking for and what features you would like.
...
Go to our [Attribution and Contributing page](https://facebookresearch.github.io/projectaria_tools/docs/attribution_citation) if you’d like to find out how to cite Project Aria or contribute to our open tooling.

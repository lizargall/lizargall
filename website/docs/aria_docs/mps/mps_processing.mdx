...
description: How MPS Data is processed.
---
...
* Go to [Machine Perception Services](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps) to find out more about the data

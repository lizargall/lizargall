...
If you cannot upload your data to MPS, it could be that your VRS file is timing out during upload. Trying a faster internet connection or reducing your VRS file’s size may help. If you are using the Desktop app, you may also wish to try the [MPS CLI](mps_cli.mdx), which enables resumable uploads.

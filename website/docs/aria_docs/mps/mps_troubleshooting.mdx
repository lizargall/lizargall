...
description: Troubleshooting support for issues relating to Project Aria's MPS.
---
## Overview
...
This page provides troubleshooting support for issues relating to Project Aria's [Machine Perception Services (MPS)](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps). If you can't find a solution for your problem on this page, go to the [Support page](https://facebookresearch.github.io/projectaria_tools/docs/support) for how to contact our team.
...
The [MPS Data Formats section](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/mps_summary) of the wiki provides more information about each MPS output and links to visualizers you can use with this data.
...
When requesting [support](https://facebookresearch.github.io/projectaria_tools/docs/support), please include:
...
:::note
Linux support for the Desktop app is limited (see [requirements](https://facebookresearch.github.io/projectaria_tools/docs/ARK/about_ARK#desktop-companion-app)) and only v36 is available. Please use the [MPS CLI to](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/request_mps/mps_cli) to request Hand Tracking MPS.
:::
...
If you cannot upload your data to MPS, it could be that your VRS file is timing out during upload. Trying a faster internet connection or reducing your VRS file’s size may help. If you are using the Desktop app, you may also wish to try the [MPS CLI](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/request_mps/mps_cli), which enables resumable uploads.

* [MPS CLI](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/request_mps/mps_cli)
* [How to Reduce VRS File Size](https://facebookresearch.github.io/projectaria_tools/docs/ARK/troubleshooting/reduce_vrs_file_size)
...
Trajectory and Eye Gaze derived data can only be generated if they have the necessary sensor data. Go to the [Recording Profiles](https://facebookresearch.github.io/projectaria_tools/docs/tech_spec/recording_profiles) for information about supported profiles.

...
* Recent documentation improvements include:
    ...
    * **Updated** [Intro page](intro.md) and [About ARK](https://facebookresearch.github.io/projectaria_tools/docs/ARK/about_ARK)
...
* [How to Create Time Synchronized Recordings with Multiple Aria Glasses](https://facebookresearch.github.io/projectaria_tools/docs/ARK/sdk/ticsync)
...
* Update to Aria Client SDK V1.1
    * [Project Aria Client SDK and CLI Setup Guide](https://facebookresearch.github.io/projectaria_tools/docs/ARK/sdk/setup)
...
* Post to [Academic Partners Feedback and Support workplace group](https://facebookresearch.github.io/projectaria_tools/docs/ARK/workplacegroup) - discussion, feedback or user support
...
The Aria Mobile App v165 is now available. Go to the [Downloads page](https://facebookresearch.github.io/projectaria_tools/docs/ARK/ark_downloads) to get the latest version for Android. For iOS, select **Update** in the TestFlight app. Please update the app to access the following features and bug fixes.

Project Aria recently released [Project Aria Eye Tracking](https://github.com/facebookresearch/projectaria_eyetracking), an open source inference code for the [Pre March 2024 Eye Gaze Model](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/mps_eye_gaze) used by MPS. This model:
...
Go to our [Support page](https://facebookresearch.github.io/projectaria_tools/docs/support) for ways to get in touch.
...
You’ll be prompted to update the app when you open it, and you can also [manually download it](https://facebookresearch.github.io/projectaria_tools/docs/ARK/ark_downloads).

You’ll need Aria OS version 4968999.0.70 (April 25th, 2024) or later to be able to set custom recording profiles.

* [How to manually update the OS](https://facebookresearch.github.io/projectaria_tools/docs/ARK/troubleshooting/update_glasses_os)

### Custom Recording Profile

To keep the new Custom Recording Profile feature approachable, and to reduce our testing matrix, we are launching this feature with a limited set of parameters. If people find the feature useful, we are open to unblocking research needs by providing the ability to include additional parameters. Please use one of our [support channels](https://facebookresearch.github.io/projectaria_tools/docs/support) to make feature requests.
...
* Documentation
    * the latest documentation updates including:
        ...
        * New [Collaborative Tools Page](https://facebookresearch.github.io/projectaria_tools/docs/collaborative_tools), did you know you can use Aria data with Nerfstudio? We’ve collaborated with Nerfstudio to enable Gaussian Splatting with their tools.
        * Updated MPS [Google Colab tutorials](/https://facebookresearch.github.io/projectaria_tools/docsdata_utilities/getting_started#running--jupyter-notebooks-on-google-colab).
...
* [Hand Tracking Data Format](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/hand_tracking/hand_tracking)
* [MPS CLI](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/request_mps/mps_cli)
* [Install/Update Project Aria Tools Using Pip](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/installation/installation_python)
* [Download Desktop app](https://facebookresearch.github.io/projectaria_tools/docs/ARK/ark_downloads#desktop-companion-app)
...
* [Eye Gaze Data Formats page](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/mps_eye_gaze) - schema has been updated
* [Eye Gaze Code Snippets](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/core_code_snippets/eye_gaze_code) - new page


#### Known Issues

* The new Eye Gaze model does not generate `yaw_rads_cpf` outputs
    * This value can be computed using [helper functions](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/core_code_snippets/eye_gaze_code#helper) and is automatically read when parsed with our data utilities.
...
The Streaming button in the dashboard has been renamed to Preview, to better reflect the capability provided by the Desktop app. Use the [Client SDK with CLI](https://facebookresearch.github.io/projectaria_tools/docs/ARK/sdk/sdk) to stream data.
...
* Python users: [Update projectaria_tools Python package](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/installation/installation_python)
    * Install via Pip to be able to request Hand Tracking data using the MPS CLI
* C++ users: [Update projectaria_tools git repository](https://facebookresearch.github.io/projectaria_tools/docs/data_utilities/installation/download_codebase)
...
Update to the latest version of the OS to access these profiles. Your glasses’ OS should automatically update when connected to Wi-Fi and power. Go to [Updating OS](https://facebookresearch.github.io/projectaria_tools/docs/ARK/troubleshooting/update_glasses_os) to manually trigger an update.
...
Or go to [Recording Profiles](https://facebookresearch.github.io/projectaria_tools/docs/tech_spec/recording_profiles) documentation in Project Aria Tools.
...
* Make sure your glasses’ OS is less than 2 months old, to make sure you have a fix for an issue that may cause sluggish behavior in your Aria glasses, difficulties updating the OS, streaming data and reduced upload times.
    * [Updating OS](https://facebookresearch.github.io/projectaria_tools/docs/ARK/troubleshooting/update_glasses_os) includes troubleshooting steps if you have difficulties updating the OS.


### Mobile Companion App v155

Please keep in mind, you can’t initiate recordings through the Mobile app if your glasses’ OS is more than 2 months old. Please make sure you update your [glasses’ OS](https://facebookresearch.github.io/projectaria_tools/docs/ARK/troubleshooting/update_glasses_os).
...
To experience the power of Aria MPS CLI, go to the [Project Aria MPS CLI page](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/request_mps/mps_cli) for how to use it.

Videos of this feature are available in the [Project Aria Academic Partner Announcements, Feedback & Support workplace group](https://facebookresearch.github.io/projectaria_tools/docs/ARK/workplacegroup)


###  ⭐️MPS: MULTI-SLAM/MULTI-SEQUENCE MAP ALIGNMENT

This addition brings the ability to generate SLAM output in a common frame of reference and support for multi-sequence SLAM outputs in a common frame of reference. Please go to [Multi-SLAM page](https://facebookresearch.github.io/projectaria_tools/docs/data_formats/mps/slam/mps_multi_slam) for more information about the feature and go to the [MPS CLI page](https://facebookresearch.github.io/projectaria_tools/docs/ARK/mps/request_mps/mps_cli) for how to access it.

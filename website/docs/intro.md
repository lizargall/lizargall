...
Liz Argall is a technical writer, program manager, author and trainer who delivers humanizing, data informed, accessible and technically complex projects for a range of organizations, from Fortune 500 companies to small nonprofits (such as [Ngombor Community Development Alliance](https://ngombor.org/) in Uganda).
